...
class AddressLookupFileDownloadFunction extends RequestHandler[java.util.Map[String, Object], String] {
  override def handleRequest(batchInfo: java.util.Map[String, Object], context: Context): String = {
